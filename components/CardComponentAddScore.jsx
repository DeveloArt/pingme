...
const CardComponentAddScore = ({icon, firstText, secondText, description, left, handleSetVisibleModal, handleSetInvitationModal}) => {
...
export default CardComponentAddScore;