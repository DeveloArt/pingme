...
const Profile = () => {
  ...
  return (
    <View style={{ backgroundColor: theme.colors.background, height: '100%', padding: 24 }}>
      <View style={styles.userAccount}>
        <Avatar.Image size={98} source={UserPhotoPlug} style={styles.avatar}/>
      ...
      <View style={styles.tableWrapper}>
        <View style={styles.tableTop}>
          ...
          <View style={styles.button}>
            <Button buttonColor={theme.colors.darkGray} style={styles.button} icon={PlusIcon}>
