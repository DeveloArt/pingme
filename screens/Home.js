...
const Home = () => {
  ...
  const [isVisibleDrawOpponentModal, setIsVisibleDrawOpponentModal] = useState(0);
  ...
  return (
	<Screen>
	  ...
	  <SendInvitationModal isVisible={isVisibleInvitationModal} handleCloseInvitationModal={handleCloseInvitationModal}/>
	  <DrawOpponentModal isVisible={isVisibleDrawOpponentModal} handleCloseDrawOpponentModal={handleCloseDrawOpponentModal} />
	</Screen>
  )
}
